...
graph TB
    ...
    subgraph AI["FastAPI AI Backend (Port 8000)"]
    ...
    Service -->|POST /infer| Infer
    Infer -->|Fetch Image| API
    Infer --> YOLO
    YOLO -->|Anomaly Results| Infer
    Infer -->|JSON Response| Service
    Service -->|Store Anomalies| DB
